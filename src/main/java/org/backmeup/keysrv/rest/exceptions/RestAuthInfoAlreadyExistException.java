...
public class RestAuthInfoAlreadyExistException extends WebApplicationException
{
	...
	{
		super (Response.status (400).entity (new ExceptionContainer ("RestAuthInfoAlreadyExistException", "Authinfo with bmu_authinfo_id (" + bmu_authinfo_id + ") already exists")).build ());
	}
}
