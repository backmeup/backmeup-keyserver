...
public class TokenRequestContainer
{
	...
	public TokenRequestContainer (long bmu_user_id, String user_pwd, long[] bmu_service_ids, long[] bmu_authinfo_ids, long backupdate, boolean reusable, String encryption_pwd)
	{
