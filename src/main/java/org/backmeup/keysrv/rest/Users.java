...
public class Users {
	...
	public void registerUser(@PathParam("bmu_user_id") long bmu_user_id,
			@PathParam("bmu_user_pwd") String bmu_user_pwd) {
		UserDao userdao = DataManager.getUserDao();
	...
	@Produces("application/json")
	public void validateUser(@PathParam("bmu_user_id") long bmu_user_id,
			@PathParam("bmu_user_pwd") String bmu_user_pwd) {
		UserDao userdao = DataManager.getUserDao();
		User user = userdao.getUser(bmu_user_id);
	...
	@Produces("application/json")
	public void changeUserPwd(@PathParam("bmu_user_id") long bmu_user_id,
			@PathParam("new_bmu_user_pwd") String new_bmu_user_pwd,
			@PathParam("old_bmu_user_pwd") String old_bmu_user_pwd) {
		UserDao userdao = DataManager.getUserDao();
		User user = userdao.getUser(bmu_user_id);
	...
	public void changeUserKeyringPwd(
			...
			@PathParam("new_bmu_user_keyring_pwd") String new_bmu_user_keyring_pwd,
			@PathParam("old_bmu_user_keyring_pwd") String old_bmu_user_keyring_pwd) {
		UserDao userdao = DataManager.getUserDao();
