...
public class KeyserverUtils {
	...
	public static ValidatableResponse createAccessToken(long userId,
			String password, long serviceId, long authInfoId, long backupDate,
	...
	@SuppressWarnings("unchecked")
	public static void addAuthInfo(long userId, String password,
			long serviceId, long authInfoId, Properties authInfoProperties) {
	...
	public static void addUser(String userId, String password) {
		given().header("Accept", "application/json").when()
				.post("/users/" + userId + "/" + password + "/register").then()
